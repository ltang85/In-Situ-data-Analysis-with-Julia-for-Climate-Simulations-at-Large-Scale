...
\begin{algorithmic}[1]
\Require{EAM simulation data.} 
\Ensure{A list of time steps and corresponding simulation years when SSW is detected.}
\Statex
\For{each EAM time\_step}
  \If{(current\_time\_step == end\_of\_day)}
