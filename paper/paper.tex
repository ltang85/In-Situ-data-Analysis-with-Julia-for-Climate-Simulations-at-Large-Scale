...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth, height=3.5cm]{infra.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{ssw_results.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{insitu_pca.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth, height=5.5cm]{ssw_break.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth, height=5.5cm]{pca_break.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth, height=5.5cm]{ssw_trend.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth, height=5.5cm]{pca_trend.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth, height=6cm]{ssw_outliers.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth, height=6cm]{pca_outliers.pdf}
