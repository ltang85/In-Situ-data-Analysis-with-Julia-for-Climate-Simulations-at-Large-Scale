...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth, height=3.5cm]{paper/figures/infra.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{paper/figures/ssw_results.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{paper/figures/insitu_pca.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth, height=5.5cm]{paper/figures/ssw_break.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth, height=5.5cm]{paper/figures/pca_break.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth, height=5.5cm]{paper/figures/ssw_trend.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth, height=5.5cm]{paper/figures/pca_trend.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth, height=6cm]{paper/figures/ssw_outliers.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth, height=6cm]{paper/figures/pca_outliers.pdf}
